...
if __name__ == "__main__":
    ...
    config.DATASET.TRAINSET = r"E:\Workspace\data\face-direction\AFLW2000\aflw2000.txt"
    config.DATASET.ROOT = r"E:\Workspace\data\face-direction\AFLW2000"
    ds = AFLW2000(config, return_pose=True)
